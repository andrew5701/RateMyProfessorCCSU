...
def add_review(request, professor_id, user_id):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            heading_text = form.cleaned_data.get('heading')
